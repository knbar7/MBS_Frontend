...
export const IntentionForm = () => {
  ...
  return (
    <div className="daily-items-container">
      ...
      <br />
      <form
        onSubmit={(e) => handleSubmitIntention(e, user.id)}
      ...
      >
        <input
          ...
          onChange={(e) => handleChange(e, "intention")}
        />
        <input
          type="text"
          name="cue1"
          placeholder="Cue 1"
          onChange={(e) => handleChange(e, "cue1")}
        />
        <input
          type="text"
          name="cue2"
          placeholder="Cue 2"
          onChange={(e) => handleChange(e, "cue2")}
        />
        <input
          type="text"
          name="cue3"
          placeholder="Cue 3"
          onChange={(e) => handleChange(e, "cue3")}
        />
