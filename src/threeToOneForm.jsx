...
export const ThreeToOneForm = () => {
  ...
  return (
    <div className="daily-items-container">
      ...
      <br />
      <form
        onSubmit={(e) => handleSubmitThreeToOne(e, user.id)}
        className="input-form"
      >
        <input
          type="text"
          name="worked1"
          placeholder="Worked 1"
          onChange={(e) => handleChange(e, "worked1")}
        />
        <input
          type="text"
          name="worked2"
          placeholder="Worked 2"
          onChange={(e) => handleChange(e, "worked2")}
        />
        <input
          type="text"
          name="worked3"
          placeholder="Worked 3"
          onChange={(e) => handleChange(e, "worked3")}
        />
        <input
          type="text"
          name="improve1"
          placeholder="Improve 1"
          onChange={(e) => handleChange(e, "improve1")}
        />
